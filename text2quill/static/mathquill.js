...
var Node = P(function(_) {
  ...
  _.jQize = function(jQ) {
    ...
    function jQadd(el) {
      if (el.getAttribute) {
        var cmdId = el.getAttribute('mq-cmd-id');
        var blockId = el.getAttribute('mq-b-id');
...
function getInterface(v) {
  ...
  function MQ(el) {
    ...
    var blockId = $(el).children('.mq-r-b').attr(mqBlockId);
  ...
  var AbstractMathQuill = APIClasses.AbstractMathQuill = P(Progenote, function(_) {
    ...
    _.__mathquillify = function(classNames) {
      ...
      root.jQ =
        $('<span class="mq-r-b"/>').attr(mqBlockId, root.id).appendTo(el);
...
Controller.open(function(_) {
  ...
  _.delegateMouseEvents = function() {
    ...
    this.container.bind('mousedown.mathquill', function(e) {
      var rootjQ = $(e.target).closest('.mq-r-b');
...
var MathCommand = P(MathElement, function(_, super_) {
  ...
  */
  ...
  _.html = function() {
    ...
    // - insert the mq-cmd-id attribute into all top-level tags,
    ...
    //       rendered as HTML
    //     + insert the mq-b-id attribute into the containing tag
    ...
    return tokens.join('').replace(/>&(\d+)/g, function($0, $1) {
      return ' mq-b-id=' + blocks[$1].id + '>' + blocks[$1].join('html');
    });
  };
...
var TextBlock = P(Node, function(_, super_) {
  ...
  _.html = function() {
    return (
        '<span class="mq-text-mode" mq-cmd-id='+this.id+'>'
      +   this.textContents()
      + '</span>'
    );
  };
